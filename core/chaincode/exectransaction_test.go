...
import (
	...
	"github.com/idci/core/container"
	"github.com/idci/core/ledger"
...
func TestExecuteDeployTransaction(t *testing.T) {
	...
	url := "github.com/idci/examples/chaincode/go/chaincode_example01"
	f := "init"
...
func TestExecuteInvokeTransaction(t *testing.T) {
	...
	url := "github.com/idci/examples/chaincode/go/chaincode_example02"
...
func TestExecuteInvalidQuery(t *testing.T) {
	...
	url := "github.com/idci/examples/chaincode/go/chaincode_example03"
...
func TestChaincodeInvokeChaincode(t *testing.T) {
	...
	url1 := "github.com/idci/examples/chaincode/go/chaincode_example02"
	...
	url2 := "github.com/idci/examples/chaincode/go/chaincode_example04"
...
func TestChaincodeQueryChaincode(t *testing.T) {
	...
	// Deploy second chaincode
	url2 := "github.com/idci/examples/chaincode/go/chaincode_example05"
